...
const PrivacyPolicy: React.FunctionComponent = () => {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to Huset Café & Motell,
        ...
        <li>
          <strong>Website</strong> refers to Huset Café & Motell, accessible
          from https://husetmotell.no
        </li>{' '}
        <li>
      ...
      <ul>
        <li>By email: kontakt@husetmotell.no</li>
        <li>
